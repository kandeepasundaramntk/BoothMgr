...
export function BoothsTab({ assemblyId, electionId }: { assemblyId: string; electionId: string }): JSX.Element {
  ...
  const booths = useQuery({
    queryKey: ['booths', assemblyId, electionId],
    queryFn: async () => (await getApi()).listBooths(assemblyId, electionId),
  ...
  const importMutation = useMutation({
    ...
    onSuccess: (added) => {
      ...
      setError(null)
      void queryClient.invalidateQueries({ queryKey: ['booths', assemblyId, electionId] })
    },
